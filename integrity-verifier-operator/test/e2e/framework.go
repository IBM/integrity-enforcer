...
var (
	...
	integrityVerifierOperatorCR         = deploy_dir + "apis_v1alpha1_integrityverifier.yaml"
	integrityVerifierOperatorCR_updated = deploy_dir + "apis_v1alpha1_integrityverifier_update.yaml"
