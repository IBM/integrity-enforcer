...
// +kubebuilder:rbac:groups=apis.integrityenforcer.io,resources=integrityenforcers;enforcerconfigs;signpolicies;resourcesigningprofiles;resourcesignatures;helmreleasemetadatas,verbs=get;list;watch;create;update;patch;delete
