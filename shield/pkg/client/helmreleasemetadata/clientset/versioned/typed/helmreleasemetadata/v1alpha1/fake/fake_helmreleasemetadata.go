...
type FakeHelmReleaseMetadatas struct {
	Fake *FakeIntegrityshieldV1alpha1
	ns   string
}

var helmreleasemetadatasResource = schema.GroupVersionResource{Group: "integrityshield.io", Version: "v1alpha1", Resource: "helmreleasemetadatas"}

var helmreleasemetadatasKind = schema.GroupVersionKind{Group: "integrityshield.io", Version: "v1alpha1", Kind: "HelmReleaseMetadata"}
