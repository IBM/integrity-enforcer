...
import (
	...
	"github.com/IBM/integrity-enforcer/shield/pkg/client/shieldconfig/clientset/versioned/scheme"
...
func (c *ApisV1alpha1Client) ShieldConfigs(namespace string) ShieldConfigInterface {
	return newShieldConfigs(c, namespace)
}
