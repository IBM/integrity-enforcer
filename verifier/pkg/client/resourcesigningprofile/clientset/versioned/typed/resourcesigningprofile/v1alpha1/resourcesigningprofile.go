...
import (
	...
	v1alpha1 "github.com/IBM/integrity-enforcer/verifier/pkg/apis/resourcesigningprofile/v1alpha1"
	scheme "github.com/IBM/integrity-enforcer/verifier/pkg/client/resourcesigningprofile/clientset/versioned/scheme"
...
type ResourceSigningProfileInterface interface {
	...
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.ResourceSigningProfileList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ResourceSigningProfile, err error)
	ResourceSigningProfileExpansion
}
...
func (c *resourceSigningProfiles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ResourceSigningProfileList, err error) {
...
func (c *resourceSigningProfiles) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *resourceSigningProfiles) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
