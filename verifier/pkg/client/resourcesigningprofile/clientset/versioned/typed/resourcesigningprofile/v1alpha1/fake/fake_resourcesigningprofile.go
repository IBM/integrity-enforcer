...
var resourcesigningprofilesResource = schema.GroupVersionResource{Group: "apis.integrityverifier.io", Version: "v1alpha1", Resource: "resourcesigningprofiles"}

var resourcesigningprofilesKind = schema.GroupVersionKind{Group: "apis.integrityverifier.io", Version: "v1alpha1", Kind: "ResourceSigningProfile"}
...
func (c *FakeResourceSigningProfiles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ResourceSigningProfileList, err error) {
	...
	list := &v1alpha1.ResourceSigningProfileList{ListMeta: obj.(*v1alpha1.ResourceSigningProfileList).ListMeta}
	for _, item := range obj.(*v1alpha1.ResourceSigningProfileList).Items {
