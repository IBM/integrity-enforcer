...
import (
	...
	"github.com/IBM/integrity-enforcer/verifier/pkg/client/verifierconfig/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type ApisV1alpha1Interface interface {
	RESTClient() rest.Interface
	VerifierConfigsGetter
}
...
func (c *ApisV1alpha1Client) VerifierConfigs(namespace string) VerifierConfigInterface {
	return newVerifierConfigs(c, namespace)
}
