...
import (
	...
	"github.com/IBM/integrity-enforcer/verifier/pkg/client/resourcesignature/clientset/versioned/scheme"
...
func (c *ApisV1alpha1Client) ResourceSignatures(namespace string) ResourceSignatureInterface {
