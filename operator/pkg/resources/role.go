		...
		Rules: []rbacv1.PolicyRule{
			{
				...
				Resources: []string{
					"secrets", "namespaces", "resourcesignatures", "enforcerconfigs", "signpolicies", "vsignpolicies", "vresourceprotectionprofiles", "vclusterresourceprotectionprofiles", "resourcesignatures",
				},
				Verbs: []string{
