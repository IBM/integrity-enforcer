		...
		Rules: []rbacv1.PolicyRule{
			{
				...
				Resources: []string{
					"secrets", "namespaces", "resourcesignatures", "enforcerconfigs", "signpolicies", "signpolicies", "vresourceprotectionprofiles", "vclusterresourceprotectionprofiles", "resourcesignatures",
				},
				Verbs: []string{
