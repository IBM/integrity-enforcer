		...
		Rules: []rbacv1.PolicyRule{
			{
				...
				Resources: []string{
					"secrets", "namespaces", "resourcesignatures", "enforcerconfigs", "signpolicies", "signpolicies", "resourceprotectionprofiles", "clusterresourceprotectionprofiles", "resourcesignatures",
				},
				Verbs: []string{
