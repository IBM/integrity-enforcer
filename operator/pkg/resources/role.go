		...
		Rules: []rbacv1.PolicyRule{
			{
				...
				Resources: []string{
					"secrets", "namespaces", "resourcesignatures", "enforcerconfigs", "signpolicies", "vsignpolicies", "vresourceprotectionprofiles", "vclusterresourceprotectionprofiles", "vresourcesignatures",
				},
				Verbs: []string{
