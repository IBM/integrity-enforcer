...
func (r *ReconcileIntegrityEnforcer) createOrUpdateConfigMap(instance *researchv1alpha1.IntegrityEnforcer, expected *v1.ConfigMap) (reconcile.Result, error) {
...
func (r *ReconcileIntegrityEnforcer) createOrUpdateRuleTableConfigMap(instance *researchv1alpha1.IntegrityEnforcer) (reconcile.Result, error) {
