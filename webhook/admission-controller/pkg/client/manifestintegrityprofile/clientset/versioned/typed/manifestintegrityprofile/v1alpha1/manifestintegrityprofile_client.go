...
import (
	...
	"github.com/IBM/integrity-shield/webhook/admission-controller/pkg/client/manifestintegrityprofile/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type ApisV1alpha1Interface interface {
	RESTClient() rest.Interface
	ManifestIntegrityProfilesGetter
}
...
func (c *ApisV1alpha1Client) ManifestIntegrityProfiles() ManifestIntegrityProfileInterface {
	return newManifestIntegrityProfiles(c)
}
