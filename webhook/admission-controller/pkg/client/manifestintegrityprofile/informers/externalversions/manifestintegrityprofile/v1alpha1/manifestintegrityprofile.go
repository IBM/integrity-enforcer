...
import (
	...
	manifestintegrityprofilev1alpha1 "github.com/IBM/integrity-shield/webhook/admission-controller/pkg/apis/manifestintegrityprofile/v1alpha1"
	versioned "github.com/IBM/integrity-shield/webhook/admission-controller/pkg/client/manifestintegrityprofile/clientset/versioned"
	internalinterfaces "github.com/IBM/integrity-shield/webhook/admission-controller/pkg/client/manifestintegrityprofile/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/IBM/integrity-shield/webhook/admission-controller/pkg/client/manifestintegrityprofile/listers/manifestintegrityprofile/v1alpha1"
...
type ManifestIntegrityProfileInformer interface {
	...
	Lister() v1alpha1.ManifestIntegrityProfileLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApisV1alpha1().ManifestIntegrityProfiles().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApisV1alpha1().ManifestIntegrityProfiles().Watch(context.TODO(), options)
			},
		},
		&manifestintegrityprofilev1alpha1.ManifestIntegrityProfile{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *manifestIntegrityProfileInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&manifestintegrityprofilev1alpha1.ManifestIntegrityProfile{}, f.defaultInformer)
}

func (f *manifestIntegrityProfileInformer) Lister() v1alpha1.ManifestIntegrityProfileLister {
	return v1alpha1.NewManifestIntegrityProfileLister(f.Informer().GetIndexer())
}
