...
import (
	...
	"github.com/IBM/integrity-enforcer/controller/pkg/client/resourceauditreview/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type ApisV1alpha1Interface interface {
	RESTClient() rest.Interface
	ResourceAuditReviewsGetter
}
...
func (c *ApisV1alpha1Client) ResourceAuditReviews() ResourceAuditReviewInterface {
	return newResourceAuditReviews(c)
}
