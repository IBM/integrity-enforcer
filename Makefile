...
tag-images-to-local:
	...
	docker tag $(ISHIELD_EMULATOR_IMAGE_NAME_AND_VERSION) $(TEST_ISHIELD_EMULATOR_IMAGE_NAME_AND_VERSION)
...
push-images-to-local: tag-images-to-local
	...
	docker push $(TEST_ISHIELD_EMULATOR_IMAGE_NAME_AND_VERSION)
