...
IMAGE_REMOTE=integrityenforcer/ie-server:0.0.3rc2
IMAGE_LOCAL=ie-server:local
BASEDIR=./deployment
DOCKERFILE=./image/Dockerfile

LOGG_BASEDIR=${IE_REPO_ROOT}/logging/
LOGG_IMAGE_REMOTE=integrityenforcer/ie-logging:0.0.3rc2
...
CSV_VERSION_LOCAL=0.0.3rc2
CSV_VERSION=0.0.3rc2
