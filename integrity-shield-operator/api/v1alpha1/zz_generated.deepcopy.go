...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InspectorContainer) DeepCopyInto(out *InspectorContainer) {
	*out = *in
	if in.Enabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InspectorContainer.
func (in *InspectorContainer) DeepCopy() *InspectorContainer {
	if in == nil {
		return nil
	}
	out := new(InspectorContainer)
	in.DeepCopyInto(out)
	return out
}
...
func (in *IntegrityShieldSpec) DeepCopyInto(out *IntegrityShieldSpec) {
	*out = *in
	...
	in.Inspector.DeepCopyInto(&out.Inspector)
