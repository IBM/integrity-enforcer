...
import (
	...
	"github.com/IBM/integrity-enforcer/inspector/pkg/client/protectedresourceintegrity/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type ApisV1alpha1Interface interface {
	RESTClient() rest.Interface
	ProtectedResourceIntegritiesGetter
}
...
func (c *ApisV1alpha1Client) ProtectedResourceIntegrities(namespace string) ProtectedResourceIntegrityInterface {
	return newProtectedResourceIntegrities(c, namespace)
}
