...
read
pe "make install-operator DEMO_ISHIELD_OP_IMAGE_NAME=${ISHIELD_OPERATOR_IMAGE_NAME_AND_VERSION}"
echo
echo "===== Integrtity Shield operator is being deployed in cluster. ====="
echo
echo "Then, we set up IntegrityShield custome resource (CR)."
make setup-tmp-cr DEMO_ISHIELD_SERVER_IMAGE_NAME=${ISHIELD_SERVER_IMAGE_NAME_AND_VERSION} DEMO_ISHIELD_LOGGING_IMAGE_NAME=${ISHIELD_LOGGING_IMAGE_NAME_AND_VERSION}
echo
