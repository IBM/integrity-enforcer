...
read
pe "make setup-demo DEMO_ISHIELD_OP_IMAGE_NAME=${TEST_ISHIELD_OPERATOR_IMAGE_NAME_AND_VERSION} DEMO_ISHIELD_SERVER_IMAGE_NAME=${TEST_ISHIELD_SERVER_IMAGE_NAME_AND_VERSION} DEMO_ISHIELD_OBSERVER_IMAGE_NAME=${TEST_ISHIELD_OBSERVER_IMAGE_NAME_AND_VERSION}"
echo
