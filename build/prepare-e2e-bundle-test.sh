...
if [ "${ISHIELD_ENV}" = local ]; then
    BUNDLE_INDX_IMAGE=${ISHIELD_OPERATOR_INDEX_IMAGE_NAME_AND_VERSION}
else
    BUNDLE_INDX_IMAGE=${ISHIELD_OPERATOR_INDEX_IMAGE_NAME_AND_VERSION}${COMPONENT_TAG_EXTENSION}
fi
