...
import (
	...
	"github.com/IBM/integrity-enforcer/enforcer/pkg/client/protectrule/clientset/versioned/scheme"
...
func (c *ResearchV1alpha1Client) ProtectRules(namespace string) ProtectRuleInterface {
	return newProtectRules(c, namespace)
}
