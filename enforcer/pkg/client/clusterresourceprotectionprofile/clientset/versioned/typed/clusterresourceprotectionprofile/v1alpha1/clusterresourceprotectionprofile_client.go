...
import (
	...
	"github.com/IBM/integrity-enforcer/enforcer/pkg/client/clusterresourceprotectionprofile/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type ResearchV1alpha1Interface interface {
	RESTClient() rest.Interface
	ClusterResourceProtectionProfilesGetter
}
...
func (c *ResearchV1alpha1Client) ClusterResourceProtectionProfiles() ClusterResourceProtectionProfileInterface {
	return newClusterResourceProtectionProfiles(c)
}
