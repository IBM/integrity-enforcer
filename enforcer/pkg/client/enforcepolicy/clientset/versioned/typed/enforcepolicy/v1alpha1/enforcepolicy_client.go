...
import (
	...
	"github.com/IBM/integrity-enforcer/enforcer/pkg/client/enforcepolicy/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type ResearchV1alpha1Interface interface {
	RESTClient() rest.Interface
	EnforcePoliciesGetter
}
...
func (c *ResearchV1alpha1Client) EnforcePolicies(namespace string) EnforcePolicyInterface {
	return newEnforcePolicies(c, namespace)
}
