...
import (
	...
	"github.com/IBM/integrity-enforcer/enforcer/pkg/client/vresourceprotectionprofile/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type ResearchV1alpha1Interface interface {
	RESTClient() rest.Interface
	VResourceProtectionProfilesGetter
}
...
func (c *ResearchV1alpha1Client) VResourceProtectionProfiles(namespace string) VResourceProtectionProfileInterface {
	return newVResourceProtectionProfiles(c, namespace)
}
