...
import (
	...
	"github.com/IBM/integrity-enforcer/enforcer/pkg/client/iedefaultpolicy/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type ResearchV1alpha1Interface interface {
	RESTClient() rest.Interface
	IEDefaultPoliciesGetter
}
...
func (c *ResearchV1alpha1Client) IEDefaultPolicies(namespace string) IEDefaultPolicyInterface {
	return newIEDefaultPolicies(c, namespace)
}
