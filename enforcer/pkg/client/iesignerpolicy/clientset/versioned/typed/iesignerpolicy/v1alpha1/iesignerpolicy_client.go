...
import (
	...
	"github.com/IBM/integrity-enforcer/enforcer/pkg/client/iesignerpolicy/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type ResearchV1alpha1Interface interface {
	RESTClient() rest.Interface
	IESignerPoliciesGetter
}
...
func (c *ResearchV1alpha1Client) IESignerPolicies(namespace string) IESignerPolicyInterface {
	return newIESignerPolicies(c, namespace)
}
