...
import (
	...
	"github.com/IBM/integrity-enforcer/enforcer/pkg/client/appenforcepolicy/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type ResearchV1alpha1Interface interface {
	RESTClient() rest.Interface
	AppEnforcePoliciesGetter
}
...
func (c *ResearchV1alpha1Client) AppEnforcePolicies(namespace string) AppEnforcePolicyInterface {
	return newAppEnforcePolicies(c, namespace)
}
