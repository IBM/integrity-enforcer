...
import (
	...
	"github.com/IBM/integrity-enforcer/enforcer/pkg/client/integrityenforcerpolicy/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type ResearchV1alpha1Interface interface {
	RESTClient() rest.Interface
	IntegrityEnforcerPoliciesGetter
}
...
func (c *ResearchV1alpha1Client) IntegrityEnforcerPolicies(namespace string) IntegrityEnforcerPolicyInterface {
	return newIntegrityEnforcerPolicies(c, namespace)
}
