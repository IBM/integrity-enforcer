...
import (
	...
	"github.com/IBM/integrity-enforcer/enforcer/pkg/client/enforcerconfig/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type ApisV1alpha1Interface interface {
	RESTClient() rest.Interface
	EnforcerConfigsGetter
}

// ApisV1alpha1Client is used to interact with features provided by the apis.integrityenforcer.io group.
type ApisV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ApisV1alpha1Client) EnforcerConfigs(namespace string) EnforcerConfigInterface {
	return newEnforcerConfigs(c, namespace)
}
