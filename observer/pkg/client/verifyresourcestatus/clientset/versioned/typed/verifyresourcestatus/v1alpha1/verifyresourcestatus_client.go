...
import (
	...
	"github.com/IBM/integrity-shield/observer/pkg/client/verifyresourcestatus/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type ApisV1alpha1Interface interface {
	RESTClient() rest.Interface
	VerifyResourceStatusesGetter
}
...
func (c *ApisV1alpha1Client) VerifyResourceStatuses(namespace string) VerifyResourceStatusInterface {
	return newVerifyResourceStatuses(c, namespace)
}
